    ...
    return (
      <aside className="side-bar">
        ...
        <form action="" className="side-bar__form">
          ...
          <label className="side-bar__label side-bar__label--yellow" htmlFor="yellow-checkbox"><div className="checkbox__div checkbox__div--yellow"></div>Administrative</label>
          <input type="checkbox" className="side-bar__checkbox" id="blue-checkbox" />
          <label className="side-bar__label side-bar__label--blue" htmlFor="blue-checkbox"><div className="checkbox__div checkbox__div--blue"></div>Design</label>
          <input type="checkbox" className="side-bar__checkbox" id="red-checkbox" />
          <label className="side-bar__label side-bar__label--red" htmlFor="red-checkbox"><div className="checkbox__div checkbox__div--red"></div>Executive</label>
          <input type="checkbox" className="side-bar__checkbox" id="green-checkbox" />
          <label className="side-bar__label side-bar__label--green" htmlFor="green-checkbox"><div className="checkbox__div checkbox__div--green"></div>Human Resources</label>
        </form>
      </aside>
    )
