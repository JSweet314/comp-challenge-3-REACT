  ...
  return (
    <section className="social">
      ...
      <div className="social__display-wrapper social__display-wrapper--no-border">
        <img src="../lib/images/globe-icon.svg" alt="globe icon" className="social__icon" />
      ...
      <div className="social__display-wrapper">
        <img src="../lib/images/widget-icon.svg" alt="widget icon" className="social__icon" />
      ...
      <div className="social__display-wrapper">
        <img src="../lib/images/paper-plane.svg" alt="paper airplane icon" className="social__icon" />
